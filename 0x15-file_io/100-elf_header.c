...
/**
 * _close - close a file descriptor and printn an error message upon failure
...
/**
 * elf_version(const unsigned char *buffer)
 * @buffer: the ELF header
 */
 ...
 */
void el_abivers(const unsigned char *buffer)
{
	char *type_table[5] = {
		"NONE (No file type",
